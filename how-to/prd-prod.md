...
## Descripción
Este documento contiene las reglas y guías para la creación de PRDs desde la perspectiva de Producto.
...
**Principios clave:**
- **Claridad sobre elegancia**: Prioriza la claridad y la simplicidad sobre el lenguaje elaborado
- **Enfoque en el problema**: Siempre empieza por el problema que se resuelve, no por la solución
- **Evidencia sobre opinión**: Basa las decisiones en datos, investigación y evidencia, no en suposiciones
- **Valor para el usuario**: Cada funcionalidad debe crear valor real para el usuario
- **Medición clara**: Define métricas específicas y medibles, no vagas

### Sección 1: Introducción/Resumen
- Empieza con el problema que se resuelve
- Explica por qué es importante resolverlo ahora
- Sé conciso: 2-3 párrafos máximo

### Sección 2: Objetivos
- Lista objetivos específicos, medibles y alcanzables
- Cada objetivo debe ser claro y directo
- Evita objetivos vagos o genéricos

### Sección 3: User Stories
